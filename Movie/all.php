	<div class="head">
         <h2>TẤT CẢ PHIM</h2>
          <p class="text-right"><a href="index.php?mod=all">See all</a></p>
    </div>
...
?>
        <div class="movie">
          <div class="movie-image"> <a href="index.php?mod=all&ac=detailall&id=<?php echo $row['id']; ?>"><span class="play" style="display: none;"><span class="name"><?php echo $row["namephim"] ?></span></span> <img src="<?php include "include/1.php" ?>/admin/module/movie/images/<?php echo $row["image"] ?>" alt=""></a> </div>
          <div class="rating">
            <p>RATING</p>
            <div class="stars">
