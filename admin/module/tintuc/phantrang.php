...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    	...
    	<tr>
           ...
           <td width="78" ><?php echo $r["date"];?></td>
            ...
            <td width="32"><a href="index.php?mod=tintuc&ac=sua&id=<?php echo $r["id"];?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td width="45"s><a href="index.php?mod=tintuc&ac=xoa&id=<?php echo $r["id"];?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
       <?php } ?>
       ...
       <?php for($j=0;$j<($q);$j++)
	   {?>
        <a href="index.php?mod=tintuc&ac=phantrang&id=<?php echo $j;?>"><?php echo $j;?></a>
        <?php }?></div>
